...
<form action="<?php echo JRoute::_('index.php?option=com_phocadownload&view=phocadownloadrafile'); ?>" method="post" name="adminForm" id="adminForm">
...
<thead>
	<tr>
		...
		<th width="5%" align="center">
			<?php echo JHtml::_('grid.sort', 'COM_PHOCADOWNLOAD_RATING', 'a.rating', $listDirn, $listOrder); ?>
		</th>
		<?php /*
		<th width="5%">
		...
		*/ ?>
		<th width="20%">
			<?php echo JHtml::_('grid.sort',  'COM_PHOCADOWNLOAD_FILE', 'file_title', $listDirn, $listOrder); ?>
		</th>
		<th width="20%">
			<?php echo JHtml::_('grid.sort',  'COM_PHOCADOWNLOAD_CATEGORY', 'category_title', $listDirn, $listOrder); ?>
		</th>
		<?php /*
		<th width="5%">
...
$linkCat	= JRoute::_( 'index.php?option=com_phocadownload&task=phocadownloadcat.edit&id='. $item->category_id );
$canEditCat	= $user->authorise('core.edit', 'com_phocadownload.phocadownloadcat.'.$item->category_id);
$linkImg	= JRoute::_( 'index.php?option=com_phocadownload&task=phocadownloadfile.edit&id='. $item->file_id );
$canEditImg	= $user->authorise('core.edit', 'com_phocadownload.phocadownloadfile.'.$item->file_id);
?>
