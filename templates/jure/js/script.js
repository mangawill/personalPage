...
*/
		...
		$(function() { // For portfolio showcase
...
$.jribbble.getShotsByPlayerId('JureStern', function (playerShots) { // Dribbble API call latest shot
    ...
    $.each(playerShots.shots, function (i, shot) {
        ...
        html.push('<ul class="clearfix"><li><i class="icon-eye-open"></i> ' + shot.views_count + '</li>');
        html.push('<li><i class="icon-heart"></i> ' + shot.likes_count + '</li>');
        html.push('<li><i class="icon-comment"></i> ' + shot.comments_count + '</li></ul>');
    });
